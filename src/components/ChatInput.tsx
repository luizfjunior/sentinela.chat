  ...
  return (
    <div className="relative">
      <form onSubmit={handleSubmit} className="relative">
        <div className="relative flex items-end bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-lg hover:shadow-xl transition-shadow">
          ...
          <Textarea
            ...
            className="flex-1 min-h-[20px] max-h-[200px] resize-none border-0 bg-transparent px-0 py-4 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus-visible:ring-0 focus-visible:ring-offset-0"
            disabled={isLoading}
            rows={1}
          />
      ...
      <p className="text-xs text-gray-500 dark:text-gray-400 text-center mt-2">
        O IA Chat Process pode cometer erros. Considere verificar informações importantes.
      </p>
    </div>
  );
};
