...
import { Trash2, MoreVertical, PanelLeft } from "lucide-react";
import { 
  DropdownMenu, 
  DropdownMenuContent, 
  DropdownMenuItem, 
  ...
  return (
    <SidebarProvider>
      <div className="flex h-screen bg-[#0f1218] text-white">
        {/* Left Side - Process Guide with Sidebar */}
        <Sidebar variant="inset" className="border-r border-gray-800">
          <SidebarHeader className="bg-[#131a27] p-3">
            <h2 className="text-lg font-medium">O que são processos? Como descrevê-los?</h2>
          </SidebarHeader>
          <SidebarContent>
